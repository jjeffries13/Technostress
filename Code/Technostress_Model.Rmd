...
number of cases). This was performed at both the effect size and study level above through use of Cook's Distances, which can be interpreted as Mahalanobis distance between the entire
set of predicted values once with the ith case included and once with the ith case excluded from the
model fitting (Viechtbauer, 2010). 
